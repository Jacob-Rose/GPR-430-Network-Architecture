...
ClientGameState::ClientGameState() : GameState(true), m_PlayerView(sf::FloatRect(0, 0, 800, 600))
{
...
void jr::ClientGameState::handleRemoteInput()
{
	GameState::handleRemoteInput(); //oranizes events into these
